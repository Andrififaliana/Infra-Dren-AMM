      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {errors.nomTrajet && <p className="text-xs text-destructive">{errors.nomTrajet}</p>}
            ...
            {errors.debutTrajet && <p className="text-xs text-destructive">{errors.debutTrajet}</p>}
            {errors.finTrajet && <p className="text-xs text-destructive">{errors.finTrajet}</p>}
            <div className="border-t pt-4">
              <p className="mb-3 text-sm font-medium text-foreground">Moyen de transport</p>
              <div className="grid grid-cols-3 gap-4">
                ...
                />
                {errors.typeMoyen && <p className="text-xs text-destructive">{errors.typeMoyen}</p>}
            ...
            <div className="border-t pt-4">
              <p className="mb-3 text-sm font-medium text-foreground">Période difficile (optionnelle)</p>
              <div className="grid grid-cols-2 gap-4">

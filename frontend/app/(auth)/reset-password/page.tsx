...
import { Shield, Eye, EyeOff, CheckCircle2, AlertTriangle, Loader2, Moon, Sun } from 'lucide-react';
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-background to-primary/5 dark:from-background dark:via-background dark:to-primary/5 px-3 sm:px-4">
        ...
        <div className="w-full max-w-md">
          <motion.div
            ...
            className="rounded-2xl border bg-card p-8 sm:p-10 shadow-sm text-center"
          >
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-destructive/10">
              <AlertTriangle className="h-8 w-8 text-destructive" />
            </div>
            <h1 className="text-xl font-bold text-foreground mb-3">Lien invalide</h1>
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-primary/5 via-background to-primary/5 dark:from-background dark:via-background dark:to-primary/5 px-3 sm:px-4">
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h1 className="text-xl font-bold text-foreground mb-3">Mot de passe réinitialisé</h1>
